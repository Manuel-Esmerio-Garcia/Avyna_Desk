...
$columns = array('ID','Fecha_Timbrado','Folio', 'Receptor', 'Receptor_RFC', 'Status', 'Subtotal', 'Impuesto', 'Retenciones', 'Descuento', 'Total','UUID');

$query = "SELECT * FROM Reporte_Timbrado WHERE ";
...
{
 $query = "SELECT * FROM Reporte_Timbrado";
