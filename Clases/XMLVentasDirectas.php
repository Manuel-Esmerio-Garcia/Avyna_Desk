...
function satxmlsv33_generales($arr, $edidata, $dir,$nodo,$addenda) {
  global $root, $xml, $fecha, $totalVenta, $descAdicional, $descVenta, $totalDescVenta, $descDistriduidor, $IVA, $IVA_2, $listProducts, $gastosAdmin, $totalFactura, $adicionalDescPorcentaje, $subtotalSI,  $totalDesc , $totalCI, $gastosEnvio;
  ...
  if (intval($arr['Venta'][0]['descuento_adicional']) > 0.0000) {
  ...
  $this->satxmlsv33_cargaAtt($root, 
    array("Version"=>"3.3",
      "Serie"=>  '',
      "Folio"=> $arr['Formulario']['idVenta'],
      "Fecha"=>$this->satxmlsv33_xml_fech($fecha),
      "Sello"=>"@",
      "FormaPago"=> $arr['Formulario']['Pago'],
      "MetodoPago"=> $arr['Formulario']['Metodo'],
      ...
      "TipoDeComprobante"=> 'I',
      "LugarExpedicion"=> $arr['Formulario']['CP']
    )
  );
}
...
function satxmlsv33_receptor($arr, $edidata, $dir,$nodo,$addenda) {
  ...
  $nombre = $this->satxmlsv33_fix_chr($arr['Formulario']['Empresa']);
...
function satxmlsv33_conceptos($arr, $edidata, $dir,$nodo,$addenda) {
  global $root, $xml, $descDistriduidor, $IVA, $IVA_2, $listProducts, $gastosAdmin, $adicionalDescPorcentaje, $totalDesc, $gastosEnvio;
