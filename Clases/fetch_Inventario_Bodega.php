...
$query = "SELECT * FROM Inventario_producto_sucursal_view WHERE idSucursal = ".$_POST["Bodega"]." AND ";
...
{
 $query .= '
  (idInventario LIKE "%'.$_POST["search"]["value"].'%" 
  ...
  OR Existencias_disponibles LIKE "%'.$_POST["search"]["value"].'%"
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = $row["Existencias_disponibles"];
...
{
$query = "SELECT * FROM Inventario_producto_sucursal_view WHERE idSucursal = ".$_POST["Bodega"];
