  ...
  var Table_Ventas_Menudeo = document.getElementById("table_reporte_ventas_menudeo");
    ...
    Table_Ventas.onclick = function(e)
    {
         ...
         try
        {
            ...
            var Subtotal    = window.Linea_Ventas.cells[3].innerHTML;
            var Impuesto    = window.Linea_Ventas.cells[4].innerHTML;
            var Status      = window.Linea_Ventas.cells[5].innerHTML;
            var Fecha       = window.Linea_Ventas.cells[6].innerHTML;
            //var Botones     = window.Linea_Ticket.cells[6].innerHTML;
