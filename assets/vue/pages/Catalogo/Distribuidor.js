/********************************************************************/
/***   Nombre Archivo: Distribuidor.js   		                  ***/
    ...
    methods: {
        ...
        _btnUnificar(){
            ...
            if (scoped.idCliente != "") {
                if (scoped.objClientSelect != []) {
                    swal({
                        title: "¿Esta segúro que desea unificar al distribuidor?",
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            let request = {
                                method : 'POST',
                                url : `${Vue.config.access.IntegrattoAccess.server}/Controller_Distribuidores/btnUnificar`,
                                data:{
                                ...
                                switch(parseInt(response.status)){
                                    case 200:
                                        switch(parseInt(response.data)){
                                            case 0:
                                                Vue.toasted.error('Ocurrio un error al unificar al distribuidor.',{duration:3000,keepOnHover:true,theme:'bubble',position:'bottom-right'});
                                                scoped.active = false;    
                                            break;        
                                            case 1:
                                                Vue.toasted.success('Distribuidor unificado con exito ',{duration:800,keepOnHover:true,theme:'bubble',position:'bottom-right'});
                                                scoped._clean();
                                            break;
                                            default:
                    ...
                    Vue.toasted.show('No se agrego ningún distribuidor a unificar.',{duration:3000,keepOnHover:true,theme:'bubble',position:'bottom-right'});
                }
            }else{
                Vue.toasted.show('No se selecciono un distribuidor principal.',{duration:3000,keepOnHover:true,theme:'bubble',position:'bottom-right'});
            }           
        },
        /********************************************************************/
        ...
        _changeCliente(){
            ...
            if (scoped.idCliente != "") {
                ...
                Vue.toasted.show('Seleccione al distribuidor principal.',{duration:3000,keepOnHover:true,theme:'bubble',position:'bottom-right'});
            }
        },
        /********************************************************************/
        ...
        _validateSelectClient(){
            ...
            if (scoped.validateSelect == 0) {
                Vue.toasted.show('Seleccione algún distribuidor.',{duration:3000,keepOnHover:true,theme:'bubble',position:'bottom-right'});
            }
        },
        /********************************************************************/
        ...
        _openModalUnificar(){
            ...
            let request = {
                method : 'POST',
                url : `${Vue.config.access.IntegrattoAccess.server}/Controller_Distribuidores/getDistribuidores`
            }
