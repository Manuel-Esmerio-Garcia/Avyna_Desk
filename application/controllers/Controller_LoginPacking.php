...
class Controller_LoginPacking extends CI_Controller {

	public function __construct() 
    {
        parent::__construct();
        // Inicializa el modelo.
        $this->load->model('LoginPacking_Model', 'login');
    }
	...
	public function index()
	{
    	...
    	$this->load->view('Login/LoginPacking');
	}
	...
	public function cerrarSesion(){
		session_destroy();
		redirect('Controller_LoginPacking');
	}
}
